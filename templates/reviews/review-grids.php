...
if ( defined( 'REST_REQUEST' ) && REST_REQUEST ) {
 //$imgurl = ITSP_INTEGRATION__PLUGIN_URL . '/assets/images/img-placeholder.jpg';  
  $imgurl = ITSP_INTEGRATION__PLUGIN_URL . '/assets/placeholders/review.png';  
echo '<img src='.$imgurl.' width="100%">';
} else {
?>
<div class="itsp_is_engage_container itsp_review_container itsp_grid_review_container" style="background:<?php echo isset($instance['reviewbgcolor']) ? $instance['reviewbgcolor'] : ''; ?>; width:100%;">
...
<!--        <h3 style="color:<?php //echo esc_attr($brandkit_colorpalette['primaryTextColor']); ?>;font-size:<?php //echo esc_attr($brandkit_fontinfo['h1']); ?>;font-family:<?php //echo esc_attr($brandkit_fontinfo['fontFamily']); ?>;line-height:<?php //echo esc_attr($brandkit_fontinfo['lineHeight']); ?>;text-align:center;width:100%;"> <?php //echo isset($instance['reviewtitle']) ? esc_attr($instance['reviewtitle']) : 'Our Client\'s Testmonials'; ?></h3>
        ...
        foreach ($revresults as $revdata) {// $revdata['rating']  
            ...
            $ngtrating = ($pstrating == 5) ? 0 : (($pstrating == 4) ? 1 : (($pstrating == 3) ? 2 : (($posrating == 2) ? 3 : (($posrating == 1) ? 4 : ($pstrating == 0 ? 5 : '')))));
